...
![Affiche de l'exposition réseau vivant. Une typographie grasse sur fond noir accompagné de lignes bleuâtres.](images/college_momo_affiche_exposition.jpg) (3)

## Lieu de mise en exposition :

475 Boulevard de l'avenir, Laval Quebec H7N 5H9 (Collège Montmorency, Grand studio, local C-1712)

![Selfie pris devant l'entrée 1 du Collège Montmorency.](images/college_momo_lieu_exposition.jpg) (3)
...
![Cartel du dispositif multimédia mission décollage.](images/college_momo_cartel.jpg) (3)
...
![Vue d'ensemble du dispositif multimédia Mission décollage. Phase de jeu à la première personne dans laquelle le ou les joueurs doivent contrôler une fusée pour l'amener sur Mars en évitant des astéroïdes fonçant tout droit sur eux.](images/college_momo_vue_ensemble.jpg) (3)
...
![Schéma de mise en espace du grand studio du collège Montmorency. Le visiteur entrant dans la pièce se dirige complètement au fond de celle-ci, où se trouve un cyclorama et, juste derrière, le panneau de contrôle du dispositif multimédia](images/college_momo_croquis.jpg) (3)

## Composantes et techniques :

Arduino : Capte les interactions des joueurs avec le panneau de contrôle et les transmet à l'ordinateur (1)

![Image des arduinos du panneau de contrôle. Ces derniers sont enfermés dans une boîte, juste en dessous de l'interface sur laquelle les différents boutons du dispositif se trouvent.](images/college_momo_arduino.jpg) (3)

Étagère d'équipement réseau : Garde l'ordinateur connecté à Internet

![Étagère gardant les différents dispositifs de l'exposition connectés à Internet. On y voit des commutateurs, des panneaux de brassage, des unités de distribution d'énergie et divers autres fils emmêlés les uns dans les autres.](images/college_momo_etagere_equipement_reseau.jpg) (3)
...
![Deux projecteurs, l'un en arrière de l'autre et légèrement décalé sur la gauche. Celui que l'on retrouve à l'arrière diffuse le fond thématique du dispositif (l'espace, les étoiles) alors que celui à l'avant s'occupe de diffuser les images du jeu.](images/college_momo_projecteurs.jpg) (3)

Console audio Behringer : Permettent de gérer les niveaux sonores des haut-parleurs.

![Console audio Behringer sur un chariot. On retrouve plusieurs prises pour lier des composants à la console audio et des boutons permettant de contrôler le gain sur les différents dispositifs permettent de faire sortir le son.](images/college_momo_console_audio_behringer.jpg) (3)

Haut-parleurs : Transmettent le son du jeu. Il y en a deux, pour un son en stéréo.

![Haut-parleurs noirs accrochés au mur.](images/college_momo_haut_parleurs.jpg) (3)

## Éléments nécessaires à la mise en exposition :

Panneau de contrôle : Permet au joueur de contrôler la fusée dans laquelle il se trouve dans le jeu vidéo.

![Photo du panneau de contrôle](images/college_momo_panneau_controle_cote_gauche.webp) (2)
![Photo du panneau de contrôle](images/college_momo_panneau_controle_cote_droit.webp) (2)
